...
- Header: los enlaces a secciones (`#carta`, ...) y el logo usan anclas relativas;
  en páginas que no son la home (404, aviso legal) apuntan a `/#seccion` y `/`
  respectivamente (si no, no navegan a ningún sitio).
